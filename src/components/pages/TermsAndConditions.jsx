...
const TermsAndConditionsPage = () => {
  return (
    <MainLayout
      title="Terms and Conditions - Badger HQ"
    ...
    >
      ...
      <p className="pt-4 font-semibold text-sm">Last updated: Sep 2024</p>

      <DocumentSection
        heading="1. Introduction"
        desc="Welcome to Badger HQ. These Terms and Conditions govern your use of our website and services. By accessing or using our website, you agree to comply with these Terms and Conditions. If you do not agree with any part of these terms, you may not access the website or use our services."
      />
      <DocumentSection
        heading="2. Use of Website"
        desc="Badger HQ is strictly intended for use by Charlie company members and key stakeholders. Unauthorized access or use of this website is prohibited. Any attempt to gain unauthorized access to the platform will result in immediate action, including potential legal consequences."
      />
      <DocumentSection
